/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aef070130b2a2b76dec41cc53522e84f)
// Runtime types generated with workerd@1.20260507.1 2026-05-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IGDB_TOKENS: KVNamespace;
		ASSETS: Fetcher;
		SUPABASE_URL: string;
		SUPABASE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_KEY" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "OPENROUTER_API_KEY">> {}
}
