...
- [ ] 3.6 `ci` and `e2e` start in parallel
- [ ] 3.7 Identify POST returns 200 in the CI log (seam armed, not 502)
- [ ] 3.8 `e2e` job wall-clock under ~10 minutes
- [ ] 3.9 Failed spec produces a downloadable `playwright-report` artifact
- [ ] 3.10 No unmasked secret value in the job log
