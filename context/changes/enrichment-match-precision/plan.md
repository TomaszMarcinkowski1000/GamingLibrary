...
- [x] 3.1 Unit tests pass (scorer + threshold + valid-short-title regression): `npm run test` — d75ab6c
- [x] 3.2 Type checking passes: `astro check` — d75ab6c
- [x] 3.3 Linting passes: `npm run lint` — d75ab6c
- [x] 3.4 Build passes: `npm run build` — d75ab6c
